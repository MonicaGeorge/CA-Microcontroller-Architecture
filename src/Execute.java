...
//			System.out.println("PC at branch= "+(Integer.parseInt(PC,2)));
//		System.out.println("immediate at bramch= "+(Integer.parseInt(SignExtend,2))*4 );
        ...
        if(OPCode.equals("0101")) {
        	if(Integer.parseInt(ALUresult)==1) {
				InstructionFetch.ProgramCount=BranchAddressResult;
			}
